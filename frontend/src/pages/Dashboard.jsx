    ...
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-white border-b border-gray-200 px-4 md:px-8 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3 md:gap-5">
          <Link to="/jobs" className="text-sm text-gray-600 hover:text-teal-600 font-medium hidden sm:block">
            Open Roles
          </Link>
          <AccountDropdown />
        </div>
      ...
      <main className="max-w-4xl mx-auto px-4 md:px-8 py-8 md:py-10">
        ...
        {requests.length === 0 ? (
          ...
          <div className="space-y-4">
            {requests.map(r => (
              <div key={r.id} className="bg-white rounded-xl border border-gray-200 p-5 md:p-6 flex flex-wrap justify-between items-center gap-3">
                <div>

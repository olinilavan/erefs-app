    ...
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-white border-b border-gray-200 px-8 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          <span className="text-sm text-indigo-600 font-medium bg-indigo-50 px-3 py-1 rounded-full border border-indigo-100">Sample Report</span>
      ...
      <main className="max-w-4xl mx-auto px-8 py-10 space-y-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8">
          <div className="flex justify-between items-start">
            <div>
              <div className="text-xs font-medium text-indigo-600 bg-indigo-50 px-3 py-1 rounded-full border border-indigo-100 inline-block mb-3">
            ...
            <div className="text-center bg-indigo-50 rounded-xl px-6 py-3 border border-indigo-100">
        ...
        <div className="bg-indigo-600 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-indigo-200 mb-6">Free during beta. No credit card required.</p>
          <Link to="/register"
            className="inline-block bg-white text-indigo-600 px-8 py-3 rounded-xl font-bold hover:bg-indigo-50 transition">
            Get Started Free →
          </Link>
        </div>
